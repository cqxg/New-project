        ...
        <div className="withicon_block__right">
          ...
          <div className="withicon_block__iconblock">
            ...
            <div className="withicon_block__muchicon">
              <div className="withicon_block__muchiconinside" style={{ backgroundImage: `url(${l})` }} />
              <div className="withicon_block__muchiconinside" style={{ backgroundImage: `url(${m})` }} />
              <div className="withicon_block__muchiconinside" style={{ backgroundImage: `url(${n})` }} />
              <div className="withicon_block__muchiconinside" style={{ backgroundImage: `url(${o})` }} />
              <div className="withicon_block__muchiconinside" style={{ backgroundImage: `url(${p})` }} />
            </div>
          </div>
        </div>
      </div>
